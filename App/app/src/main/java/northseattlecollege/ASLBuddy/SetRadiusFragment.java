 ...
 * {@link SetRadiusFragment.OnFragmentInteractionListener} interface
...
public class SetRadiusFragment extends Fragment {
    ...
    public static SetRadiusFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        radiusDisplay = (TextView)view.findViewById(R.id.textRadiusLabel);
        ...
        radiusValue.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                float radiusInMiles = (progress / 40.0f);
                radiusDisplay.setText(String.valueOf(radiusInMiles));
            }
